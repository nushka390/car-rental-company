...
export type Car = typeof CarTable.$inferInsert;
export type customer = typeof CustomerTable.$inferInsert;

export type insurance = typeof InsuranceTable.$inferInsert;
export type Location = typeof LocationTable.$inferInsert;
export type Maintenance = typeof MaintenanceTable.$inferInsert;
export type reservation = typeof ReservationTable.$inferInsert
